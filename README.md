...
## Про решение на 6-7
добавил клиент для логирования и обновил сервер (называется сервер7)


### Пример
Вот разобранный короткий пример, где двое сначала говорят, а потом оказывается, что оба звонят, поэтому продолжения нет.
